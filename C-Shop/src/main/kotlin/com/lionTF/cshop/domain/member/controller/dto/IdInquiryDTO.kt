...
data class IdInquiryRequestDTO(var memberName:String="",var email:String=""){
    companion object{
...
data class IdInquiryResponseDTO(val status:Int,val message:String,val result: IdInquiryResultDTO){
    companion object{
