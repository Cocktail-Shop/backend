...
interface AdminItemRepository: JpaRepository<Item, Long> {
    ...
    @Query("select i.itemName from Item i where i.itemName = :itemName and i.itemStatus = :itemStatus")
    fun existsByItemName(@Param("itemName") itemName: String, @Param("itemStatus")itemStatus: Boolean): String?
